...
! function(b) {
    ...
    a.prototype = {
        ...
        render: function(e) {
            ...
            var h = this.$element.find("option:selected").map(function() {
                ...
                if (d.options.subtext) {
                    //i = ' <small class="muted text-muted">' + k.data("subtext") + "</small>"
                    i = ' <small class="muted text-muted">' + d.options.subtext + "</small>";
                    sub = i + ": "
                } else {
                    i = ""
                    ...
                    if (k.attr("title") !== undefined) {
                        ...
                        if (k.val() != "") {
                            ...
                            return j + '<strong>' + k.html().replace(/&nbsp;/gi, '') + '</strong>'
                        } else {
                            showSub = false;
                            return j + k.html()
                        }
            ...
            if (!this.multiple) {
                ...
                g = sub + h.join(this.options.multipleSeparator);
            }
    ...
    b.fn.selectpicker.defaults = {
        ...
        countSelectedText: "<strong>{0} of {1} selected</strong>",
        width: false,
        container: false,
        hideDisabled: false,
        showSubtext: false,
